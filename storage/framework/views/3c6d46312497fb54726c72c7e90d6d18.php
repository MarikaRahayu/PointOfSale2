            ...
            <div class="card panel-card h-100">
                ...
                <div class="card-body">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <form
                            action="<?php echo e(route('penjualan.store')); ?>"
                            method="POST"
        ...
        <div class="col-md-6">
            ...
            <div class="card panel-card h-100">
                ...
                <div class="card-body">
                    ...
                    <form
                        action="<?php echo e(route('penjualan.checkout')); ?>"
                        method="POST"
                    >
                        ...
                        <button
                            ...
                            <?php echo e(empty($keranjang) ? 'disabled' : ''); ?>
                    ...
                    <form
                        action="<?php echo e(route('penjualan.cancel')); ?>"
                        method="POST"
                        class="mt-2"
                    >
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PointOfSale2\resources\views/penjualan/create.blade.php ENDPATH**/ ?>