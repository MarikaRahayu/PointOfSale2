    ...
    <div class="sale-card">
        ...
        <div class="sale-card-top">
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-lg-4 text-lg-end">
                    <a href="<?php echo e(route('penjualan.create')); ?>" class="btn-create">
        ...
        <div class="sale-card-body">
            ...
            <div class="search-area">
                ...
                <form action="<?php echo e(route('penjualan.index')); ?>" method="GET" class="search-form">
                    <div class="search-input-wrapper">
                        <i class="bi bi-search"></i>
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari penjualan...">
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="tanggal-transaksi">
                                        <?php if($penjualan->tanggal_transaksi): ?>
                                            <?php echo e(\Carbon\Carbon::parse($penjualan->tanggal_transaksi)->format('d M Y')); ?>

                                            <br>
                                            <small style="color:#91aab3; font-weight:600;">
                                                <?php echo e(\Carbon\Carbon::parse($penjualan->tanggal_transaksi)->format('H:i:s')); ?>

                                            </small>
                                        <?php else: ?>
                                            <?php echo e(optional($penjualan->created_at)->format('d M Y')); ?>

                                            <br>
                                            <small style="color:#91aab3; font-weight:600;">
                                                <?php echo e(optional($penjualan->created_at)->format('H:i:s')); ?>
                                ...
                                <td class="text-center">
                                    <?php if($validItems->count() > 0): ?>
                                        <?php $firstItem = $validItems->first(); ?>
                                        <div class="produk-foto-item">
                                            <?php if($firstItem->produk->foto): ?>
                                                <img src="<?php echo e(asset('storage/' . $firstItem->produk->foto)); ?>" alt="<?php echo e($firstItem->produk->nama); ?>" class="produk-thumb">
                                            <?php else: ?>
                                ...
                                <td>
                                    <?php if($validItems->count() > 0): ?>
                                        <div class="produk-item">
                                            <?php echo e($validItems->first()->produk->nama); ?>

                                        </div>
                                        <?php if($validItems->count() > 1): ?>
                                            <small class="text-muted fw-bold" style="font-size: 10.5px;">+<?php echo e($validItems->count() - 1); ?> produk lainnya</small>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?>
                                ...
                                <td class="text-center">
                                    <?php if($validItems->count() > 0): ?>
                                        <div class="jenis-item">
                                            <?php echo e($validItems->first()->produk->jenisProduk->nama ?? '-'); ?>
                                ...
                                <td>
                                    <span class="payment-badge">
                                        ...
                                        <?php echo e(ucfirst($penjualan->metode_pembayaran ?? 'Tunai')); ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="status <?php echo e($statusClass); ?>">
                                        <?php echo e(ucfirst($penjualan->status ?? 'Selesai')); ?>
                                ...
                                <td>
                                    <div class="action-wrapper">
                                        <a href="<?php echo e(route('penjualan.show', $penjualan->id)); ?>" class="btn-detail" title="Detail">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>

                                        <form action="<?php echo e(route('penjualan.destroy', $penjualan->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?');" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PointOfSale2\resources\views/penjualan/index.blade.php ENDPATH**/ ?>